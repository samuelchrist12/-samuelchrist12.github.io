...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (    
        <>
            ...
            <body className="p-16 xl:px-96  min-h-screen dots ">
                <div className="w-full flex gap-8 justify-center">
                    ...
                    <div className="bg-gray-800/50 bg-gradient-to-bl from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 'shadow-2xl shadow-gray-500/20 motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500   basis-2/3 flex flex-col justify-center items-center text-center p-10 px-24 rounded-2xl">
                        ...
                        <a href="mailto:christiawansamuel@gmail.com?subject=I%20want%20to%20work%20with%20you.">
                            <p className="p-3 px-10 rounded-full font-bold hover:underline underline-offset-4 text-xl mt-5">
                                Reach Out Directly
                            </p>
                        </a>
                    </div>
                ...
                <div className="w-full flex gap-8 justify-center mt-8">
                    ...
                    <div className="  basis-5/6 flex flex-col justify-center items-left text-justify p-3 text-base">
                        <p>
                            From the very outset of my journey in the digital
                            realm, I've been driven by a deep-seated passion for
                            design and development. Over the past four years,
                            I've poured my heart into graphic design, proudly
                            founding Ayasara along the way. Through Ayasara,
                            I've had the privilege of assisting numerous clients
                            in shaping their brand identities, from captivating
                            promotional media to engaging social media designs.
                        </p>
                        <p className="mt-8">
                            In tandem with my design pursuits, I've embraced the
                            intricate world of web development for three years.
                            I take immense pride in crafting tailored websites
                            that resonate with a brand's essence, whether it's a
                            compelling company profile or a dynamic portfolio
                            site. Each project stands as a testament to my
                            dedication to excellence and my unwavering
                            commitment to bringing visions to life in the
                            digital landscape.
                        </p>
                    </div>
                </div>
